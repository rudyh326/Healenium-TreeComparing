...
public class JsoupXMLParser implements DocumentParser {
    ...
    public Node parse(InputStream inputStream) {
        try {
            ...
            org.jsoup.nodes.Node xml = this.findRoot(Collections.singletonList(document.root()));
            int startIndex = 0;
            Deque<NodeBuilder> treeDepth = new ArrayDeque();
            return this.traverse(xml, Integer.valueOf(startIndex), treeDepth);
